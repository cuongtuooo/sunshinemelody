...
const ProductDetail = (props: IProps) => {
    ...
    return (
        <div style={{ background: '#efefef', padding: "20px 0" }}>
            <div className='view-detail-Product' style={{ maxWidth: 1440, margin: '0 auto', minHeight: "calc(100vh - 150px)" }}>
                <Breadcrumb
                    separator=">"
                    items={[
                        {
                            ...
                            <Col span={24}>
                                ...
                                <div className='rating'>
                                    ...
                                    <span className='sold'>
                                        ...
                                        Đã bán {currentProduct?.sold ?? 0}</span>
                                </div>
                                <div className='price'>
                                    <span className='currency'>
                                        {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(currentProduct?.price ?? 0)}
                                    </span>
                                </div>
